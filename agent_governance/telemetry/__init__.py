...
DEFAULT_SERVICE_NAME = "agent-governance"
DEFAULT_OTLP_HTTP_ENDPOINT: str | None = None
DEFAULT_LANGFUSE_HOST = "https://cloud.langfuse.com"
_TRACER_NAME = "agent_governance.telemetry"
...
def instrument_fastapi(app: FastAPI) -> TelemetryStatus:
    status = init_telemetry(service_name=os.getenv("OTEL_SERVICE_NAME", "agent-governance-api"))
